  ...
  return (
    <div className="relative h-screen max-h-screen w-full flex flex-col justify-between px-4 py-4 sm:py-6 bg-[#FAFDFB] dark:bg-slate-950 text-slate-900 dark:text-white select-none overflow-hidden transition-colors">
      ...
      <header className="relative z-10 w-full max-w-sm mx-auto flex items-center justify-between shrink-0">
        <span className="text-[11px] font-bold text-slate-400 dark:text-slate-500">LocoMart Super App</span>
        <span className="text-[11px] font-extrabold text-cyan-700 dark:text-cyan-300 bg-cyan-50 dark:bg-cyan-500/20 px-2.5 py-0.5 rounded-full border border-cyan-200/60 dark:border-cyan-500/30">
      ...
      <main className="relative z-10 my-auto w-full max-w-sm mx-auto flex flex-col items-center justify-center space-y-4">
        ...
        <motion.div
          ...
          className="grid place-items-center size-14 sm:size-16 rounded-full bg-[#D7F5F8] dark:bg-cyan-500/20 shadow-md shadow-cyan-500/10 text-2xl shrink-0 border border-transparent dark:border-cyan-500/30"
        >
          🎉
        </motion.div>
        ...
        <div className="grid grid-cols-2 gap-3 w-full pt-1">
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center h-24 sm:h-26 p-3 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-white/10 shadow-md shadow-cyan-900/5 dark:shadow-none space-y-1.5 hover:border-cyan-400 hover:bg-[#EEFBFD] dark:hover:bg-slate-800 transition-all cursor-pointer"
            onClick={onStartExploring}
          >
            <span className="grid size-10 place-items-center rounded-xl bg-amber-50 dark:bg-amber-500/20 text-amber-500 dark:text-amber-400">
            ...
            <span className="text-xs font-black tracking-widest text-slate-800 dark:text-white uppercase">
              EAT
            </span>
          </motion.div>
          ...
          <motion.div
            ...
            onClick={onStartExploring}
          >
            <span className="grid size-10 place-items-center rounded-xl bg-cyan-50 dark:bg-cyan-500/20 text-[#044D63] dark:text-cyan-300">
          ...
          <motion.div
            ...
            onClick={onStartExploring}
          >
            <span className="grid size-10 place-items-center rounded-xl bg-cyan-100/60 dark:bg-cyan-500/20 text-[#044D63] dark:text-cyan-300">
              <svg className="size-5.5" viewBox="0 0 24 24" fill="currentColor">
          ...
          <motion.div
            ...
            onClick={onStartExploring}
          >
            <span className="grid size-10 place-items-center rounded-xl bg-amber-50 dark:bg-amber-500/20 text-[#044D63] dark:text-amber-400">
      ...
      {/* FOOTER START EXPLORING BUTTON */}
      <footer className="relative z-10 w-full max-w-sm mx-auto pt-2 shrink-0">
        <button
          type="button"
          onClick={onStartExploring}
          className="w-full h-12 rounded-2xl bg-gradient-to-r from-cyan-400 via-[#00BCD4] to-[#044D63] hover:opacity-95 text-white font-extrabold text-sm shadow-lg shadow-cyan-500/25 transition-all flex items-center justify-center gap-2 cursor-pointer"
        >
